...
from configs import (LLM_MODELS, LLM_DEVICE, EMBEDDING_DEVICE,
                     ...
                     FSCHAT_MODEL_WORKERS, HTTPX_DEFAULT_TIMEOUT, PROMPT_TEMPLATE_JSON, PROJECT_ROOT)
...
def modify_prompt_template(type: str, name: str, value: str):
    '''
        从json中修改模板内容
        type: "llm_chat","agent_chat","knowledge_base_chat","search_engine_chat"的其中一种，如果有新功能，应该进行加入。
    '''
...
def delete_prompt_template(type: str, name: str):
    '''
        从json中删除板内容
        type: "llm_chat","agent_chat","knowledge_base_chat","search_engine_chat"的其中一种，如果有新功能，应该进行加入。
    '''
