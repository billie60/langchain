...
MODEL_ROOT_PATH = "/root/Robot-Master/Langchain-Chatchat"
...
ONLINE_LLM_MODEL = {
    ...
    "xinghuo-api": {
        "APPID": "39e5394d",
        "APISecret": "YTUzNDQ4ZWY2ODc1MjBkMTU5MWYyMGMy",
        "api_key": "95696f93afdec4e1845d9441630bfdc6",
    ...
    "qianfan-api": {
        "version": "Yi-34B-Chat",  # 注意大小写。当前支持 "ERNIE-Bot" 或 "ERNIE-Bot-turbo"， 更多的见官方文档。
        "version_url": "",  # 也可以不填写version，直接填写在千帆申请模型发布的API地址
        "api_key": "zcIChJaKLeZ1hdk1EwzGO72J",
        "secret_key": "G5b6YDuB0drQ7GLAECwNKs9iYcv4QpUB",
    ...
    "qwen-api": {
        ...
        "api_key": "sk-e47889ca47754208b3b04120f5214fd5",  # 请在阿里云控制台模型服务灵积API-KEY管理页面创建
        "provider": "QwenWorker",
    },
